...
INPUT_FILES = [
    r'D:\software\heiweilu\workspace\xgimi\code\202602027_dlp_auto\reports\Trapezoidal_coordinate_test_results\20260310\result_file_2026_03_10_16_35_35.txt',
    # 可继续添加更多文件：
