...
"""
CSV预处理脚本 - 拆分成4个象限文件
将大CSV文件(64万行)拆分成4个小文件(每个16万行)
这样每次测试只需加载对应的小文件，从50分钟降到15秒
"""
import csv
import os
import time
...
# ==================== 配置区 ====================
# 源CSV文件路径
SOURCE_CSV = r"D:\software\heiweilu\workspace\xgimi\code\20260206_dpl_auto\ak_scan_yaw_pitch_step0.10_20260204_143212"
...
# 使用自定义目录
OUTPUT_DIR = r"D:\software\heiweilu\workspace\xgimi\code\20260206_dpl_auto\CSV_quadrant_data"
